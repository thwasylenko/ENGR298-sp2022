...
class Counter:
    ...
    def __init__(self, _init=0):
        ...
        # Your code here to create a local variable (bound to class)
        # called count. Set it equal to the _init parameter
    ...
    def dec(self):
        ...
        # Your code here. Decrement the internal variable count by 1
    ...
    def inc(self):
        ...
        # Your code here. Increment the internal variable count by 1
    ...
    def get_count(self):
        ...
        #Your code here. Change the return statement below to return the value
        # of the local count
        return None
